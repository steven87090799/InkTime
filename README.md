...
> 原始碼基準以目前 checkout 為準，不固定綁定單一 Git commit SHA；部署中的版本請從 Web「診斷」頁確認 Git revision。SQLite Migration 60、AI Schema v4、ESP32 2.8.7；詳細版本、預設值與驗收邊界見[現行基線](docs/reference/CURRENT_STATE_ZH_TW.md)。
