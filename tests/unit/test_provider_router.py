...
class StubProvider(VisionProvider):
    ...
    def repair_json(self, **kwargs): return self.analyze(**kwargs)
    def submit_batch(self, requests, completion_window="24h"): return "batch"
    def poll_batch(self, batch_id): return {}
    def cancel_batch(self, batch_id): return {}
    def estimate_cost(self, model, usage): return 0
