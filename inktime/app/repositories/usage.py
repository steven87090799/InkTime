...
class UsageRepository:
    ...
    def record(self, *, provider: str, model: str, job_id: str | None, photo_id: str | None, request_type: str, input_tokens: int, output_tokens: int, cached_tokens: int, estimated_cost: float, actual_cost: float | None, started_at: str, latency_ms: int, status: str, retry_count: int = 0, error_code: str | None = None) -> None:
