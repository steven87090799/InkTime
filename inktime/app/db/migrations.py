...
def _assert_no_unfinished_migration(database: Database) -> None:
    ...
    log_event(
        LOGGER,
        logging.CRITICAL,
        "Unfinished migration detected",
        event="migration_unfinished_detected",
        error_code="MIGRATION-002",
        phase="preflight",
        details={
            "schema_version": int(unfinished["schema_version"]),
            "migration_name": str(unfinished["migration_name"]),
        },
    )
