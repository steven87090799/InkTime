...
> Source baseline: 2026-09-13, current checkout. Migration 61, AI Schema v5 and ESP32 2.8.7 are separate version contracts. See the [current-state reference](docs/reference/CURRENT_STATE_ZH_TW.md).
...
---
Follow [AGENTS.md](AGENTS.md). Known files/symbols use TARGETED directly; only discovery uses optional [scoped navigation](docs/AI_NAVIGATION.md) and the [machine-readable context index](docs/AI_CONTEXT_INDEX.json).
