...
測試日期：2026-07-17T03:46:16.801369+00:00  
...
| 批次寫入時間 | 17.835 秒 |
| 模擬掃描寫入速度 | 5,607 筆／秒 |
| 第 99,901 筆起 UI 分頁查詢 | 457.32 ms（回傳 60／總數 100,000） |
| 建立 100,000 個持久化 Job Item | 1.048 秒 |
| Job Item 數 | 100,000 |
| Worker 單次 claim | 8（有界上限 8） |
| 重啟租約回收 | 13.15 ms／8 筆 |
| 取消後停止 claim | 通過 |
| 量測期間最大 RSS | 30.39 MiB |
| 最大 RSS 相對基線增量 | 8.94 MiB |
