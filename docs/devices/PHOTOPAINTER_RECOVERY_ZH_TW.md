...
現行韌體為 2.8.7，局部實板與安全電源依據見[Rev2.0 TG28 交接](PHOTOPAINTER_REV2_TG28_HARDWARE_HANDOFF_ZH_TW.md)。恢復前先辨識實體板、保存完整 flash 本機備份；app-only 寫 `0x10000`，不清除 NVS、不改 GPIO0／5／21。現行 KEY1 電源頁會驗證 Internal Flash 正式 frame 後恢復最後成功照片，無有效 frame 才回正常網路刷新。
